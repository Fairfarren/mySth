...
<template>
  <div id="app">
    <pc v-if="pcOrPhone"></pc>
    <home v-else></home>
    <div id="svgLog" style="width:100%;height:100%;position:fixed;top:0;left:0;display:table;background: -webkit-linear-gradient(45deg, rgba(255, 255, 255, 0) 48%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0) 52%), -webkit-linear-gradient(135deg, rgba(255, 255, 255, 0) 48%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0) 52%);
...
export default {
  ...
  components: {
    Pc: resolve => require(['./components/pc/index'], resolve),
    Home: resolve => require(['./components/phone/index'], resolve)
  }
}
</script>
