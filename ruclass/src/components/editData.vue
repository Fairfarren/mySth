    ...
    <div id="editData">
        <el-form :model="ruleForm01" status-icon :rules="rules01" ref="ruleForm01" id="formUser" label-width="80px">
            ...
            <el-form-item label="性别" class="qwe sex">
                <input id="sex01" value="1" type="radio" name="sex" v-model="ruleForm01.sex">
                <label class="chooseSex" for="sex01"></label>
                男
                <input id="sex02" value="2" type="radio" name="sex" v-model="ruleForm01.sex">
                <label class="chooseSex" for="sex02"></label>
                女
                <input id="sex03" value="0" type="radio" name="sex" checked v-model="ruleForm01.sex">
